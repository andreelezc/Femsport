...
Public Class EditarInfoUsuario
    Dim objUsuario As CUsuario = New CUsuario
    ...
    Sub CargarCBO()
        objUsuario.CargarCBO(ComboBoxCargo)
    End Sub

    Private Sub EditarInfoUsuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        objUsuario.CargarCBO(ComboBoxCargo)
    End Sub
End Class