...
Public Class MDIGerente
    ...
    Private Sub VerPerfilToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VerPerfilToolStripMenuItem.Click
        VerPerfilGerente.Show()
    End Sub

    Private Sub EditarInformaciónToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EditarInformaciónToolStripMenuItem.Click
